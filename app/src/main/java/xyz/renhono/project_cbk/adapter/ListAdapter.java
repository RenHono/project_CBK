...
public class ListAdapter extends BaseAdapter {
    ...
    public ListAdapter(List<ListData> listDataList, Context context) {
...
//        holder.textView3.setText(listDataList.get(position).getSource());
        ...
        if (!listDataList.get(position).getWap_thumb().isEmpty()) {
            Picasso.with(context).load(listDataList.get(position).getWap_thumb()).into(holder.imageView);
        }
